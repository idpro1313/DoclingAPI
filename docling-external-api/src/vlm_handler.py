...
## @modulecontract
## @purpose Обрабатывать изображения документов через внешний VLM API (post-processing).
...
## @changes
## LAST_CHANGE: v0.3.1 - Post-processing VLM mode (ENV config not supported by docling-serve)
## @modulemap
